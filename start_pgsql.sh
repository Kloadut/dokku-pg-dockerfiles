...
if [[ ! -f /opt/postgresql/initialized ]]; then
    ...
    su postgres sh -c "/usr/lib/postgresql/9.1/bin/postgres --single  -D  /var/lib/postgresql/9.1/main  -c config_file=/etc/postgresql/9.1/main/postgresql.conf" <<< "CREATE DATABASE db encoding 'utf-8';"
